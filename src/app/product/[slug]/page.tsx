      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <SizeColorChooser product={product} />
            <PincodeForm />
            <div className="flex items-start">
              <span className="title-font font-medium text-2xl text-gray-100">₹{product.price}</span>
              <AddToCartBtn product={product} />
              <button className="ml-4 rounded-full w-10 h-10 bg-gray-800 p-0 border-0 inline-flex items-center justify-center text-gray-500">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
